...
//##########################################################################################################
  ...
  #define Inclinometer_Installed 2      // set to 0 for none
  ...
  #define   MaxSpeed  10     // km/h  above -> steering off
  #define   MinSpeed  .25      // km/h  below -> sterring off (minimum = 0.25)
  ...
  #include <EEPROM.h>
    ...
    static byte myip[] = { 192,168,12,77 };
    // gateway ip address
    static byte gwip[] = { 192,168,12,1 };
    ...
    static byte ipDestination[] = {192, 168, 12, 255};
    ...
    Adafruit_ADS1115 ads;     // Use this for the 16-bit version ADS1115
      #define SteerPosZero 1480 //@MR_edit jan 11 2020. orig: 1660 which is half of 3320 or 0-5v. Lower if voltage is dropping off
  #else
  ...
  int steerZero = 0;
  float steeringPositionZero = SteerPosZero; //@MR_edit was 1660 hardocoded, same as SteerPosZero so remapped for debugging
